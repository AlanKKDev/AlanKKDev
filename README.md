...
Game & Web Developer working with **Luau (Roblox)** and actively exploring **TypeScript**.  
...
- Actively learning and building web applications with **TypeScript**, focusing on OOP architecture, clean code, and REST APIs.
- Developing custom games and core gameplay mechanics in **Roblox Studio (Luau)**.
- Long-time experience in Minecraft server infrastructure, plugin development, and management (past networks peaking at 300+ concurrent players).
- Exploring backend development with **Node.js** and relational databases.
- Open for commissions and upcoming software development internships.
...
![Minecraft](https://img.shields.io/badge/Paper_/_Spigot-388E3C?style=flat-square&logo=minecraft&logoColor=white)
